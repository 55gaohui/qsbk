...
var _default = {
  ...
  //websocket地址
  websocketUrl: 'wss://ghfree.cn/wss',
  //消息提示tabbar 索引
...
var _chat = _interopRequireDefault(__webpack_require__(/*! ./chat.js */ 22));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance");}function _iterableToArrayLimit(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default =
{
  ...
  logout: function () {var _logout = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var showToast,_args2 = arguments;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:showToast = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : true;_context2.next = 3;return (
                ...
                _request.default.post('/user/logout', {}, {
                  token: true, checkToken: true }));case 3:
  ...
  OnUserCounts: function OnUserCounts() {var _this = this;
    uni.$on('updateData', function (data) {
      ...
      if (data.type == 'updateList') {
        ...
        _this.counts.today_posts_count++;
      }
      // 评论数+1
      ...
      if (data.type == 'guanzhu') {
        if (data.data) {
          ...
          console.log('1');
          if (_this.counts.fens_arr.indexOf(data.userid) != -1) {
            _this.counts.friend_count++;
          }
        } else {
          _this.counts.withfollow_count--;
          if (_this.counts.fens_arr.indexOf(data.userid) != -1) {
  ...
  getUserBind: function () {var _getUserBind = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var _ref5, _ref6, err, res;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                _request.default.get('/user/getuserbind', {}, {
                  token: true,
                  checkToken: true }));case 2:_ref5 = _context4.sent;_ref6 = _slicedToArray(_ref5, 2);err = _ref6[0];res = _ref6[1];if (
...

{
  ...
  Read: function Read(item) {
    ...
    //拿到当前会话索引
    var index = chatlist.findIndex(function (val) {
  ...
  UserBind: function UserBind(client_id) {var _this2 = this;
    ...
    then(function (data) {var _data = _slicedToArray(
      ...
      //错误处理   退出登录，重新链接等处理
      if (!_request.default.errorCheck(err, res)) return;
      //成功
  ...
  //接收未读信息
  getChatMessages: function () {var _getChatMessages = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _ref, _ref2, err, res, i, msg;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
              ...
              _request.default.errorCheck(err, res)) {_context.next = 8;break;}return _context.abrupt("return");case 8:
              //成功
              ...
              }case 9:case "end":return _context.stop();}}}, _callee, this);}));function getChatMessages() {return _getChatMessages.apply(this, arguments);}return getChatMessages;}(),

  // 监听服务器的消息事件
  Message: function Message() {var _this3 = this;
    this.SocketTask.onMessage(function (e) {
      ...
      //绑定返回结果
      if (res.type == 'bind') {
        return _this3.UserBind(res.data);
      }
      if (res.type !== 'text') return;
      //全局通知接口
      uni.$emit('UserChat', res);
      //储存到chatdetail
      _this3.__UpdateChatdetail(res);
      //更新到chatlist
      _this3.__UpdateChatlist(res);
      //总未读数+1，修改tabbar信息署  （当前不在聊天界面，CurrentToUser.userid=0）
      if (_this3.CurrentToUser.userid !== res.from_id) {
        _this3.__UpdateNoReadNum({ type: 'add' });
      }
    });
  },
  //总未读数+1，修改tabbar信息数
  __UpdateNoReadNum: function __UpdateNoReadNum() {var option = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    //获取总未读数
  ...
  //格式化数据
  __format: function __format(data) {var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    console.log('1');
    switch (option.type) {
      case 'chatlist': // 新增会话用到
        ...
        break;
      case 'chatdetail':
        var list = option.olddata; //旧数据
        var chattime = new Date().getTime(); //获取当前时间
        var length = list ? list.length : 0;
        return {
          isme: option.isme,
          userpic: option.isme ? _user.default.userinfo.userpic : data.from_userpic,
          type: data.type,
          data: data.data,
          time: chattime,
          gstime: _time.default.gettime.getChatTime(chattime, length > 0 ? list[length - 1].time : 0) //格式化时间		作用 获取聊天时间（相差300s内的信息不会显示时间）
        };
        break;
      case 'send':
        return {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": {}, "pages/news/news": {}, "pages/paper/paper": { "navigationBarTitleText": "小纸条", "enablePullDownRefresh": true }, "pages/home/home": { "navigationBarTitleText": "我的" }, "pages/search/search": { "enablePullDownRefresh": true }, "pages/add-input/add-input": {}, "pages/topic-nav/topic-nav": { "navigationBarTitleText": "话题分类" }, "pages/topic-detail/topic-detail": { "enablePullDownRefresh": true }, "pages/user-list/user-list": {}, "pages/user-chat/user-chat": {}, "pages/detail/detail": { "navigationBarTitleText": "标题" }, "pages/user-set/user-set": { "navigationBarTitleText": "设置" }, "pages/user-set-repassword/user-set-repassword": { "navigationBarTitleText": "修改密码" }, "pages/user-set-email/user-set-email": { "navigationBarTitleText": "绑定邮箱" }, "pages/user-set-userinfo/user-set-userinfo": { "navigationBarTitleText": "编辑资料" }, "pages/user-set-help/user-set-help": { "navigationBarTitleText": "意见反馈" }, "pages/user-set-about/user-set-about": { "navigationBarTitleText": "关于糗百" }, "pages/login/login": {}, "pages/user-space/user-space": { "navigationBarTitleText": "个人空间" }, "pages/user-safe/user-safe": { "navigationBarTitleText": "账号与安全" }, "pages/user-bind-phone/user-bind-phone": { "navigationBarTitleText": "绑定手机号" }, "pages/user-feedback/user-feedback": { "navigationBarTitleText": "意见反馈" }, "pages/user-history/user-history": { "navigationBarTitleText": "浏览历史" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "仿糗事百科", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#FFFFFF" } };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__0842762" };exports.default = _default;
